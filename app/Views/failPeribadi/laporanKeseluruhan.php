...
<div class="container custom-margin">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <h2 class="text-center margin-top-bottom">Laporan keseluruhan fail peribadi</h2>
            <div class="table-responsive">
                ...
                <div class="export-button-container">
                    <button id="export-pdf" class="btn btn-danger" onclick="window.location='<?= site_url('/failPeribadi/laporanKeseluruhanPDF') ?>'" aria-label="Export to PDF">
                        <i class="fas fa-file-pdf"></i> Eksport ke PDF
                    </button>
                    <button id="export-excel" class="btn btn-success" onclick="window.location='<?= site_url('/failPeribadi/laporanKeseluruhanExcel') ?>'" aria-label="Export to Excel">
