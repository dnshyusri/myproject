...
<div class="container custom-margin">
    <div class="d-flex justify-content-end">
        <a href="<?= base_url('failPeribadi/laporanTkhBln') ?>" class="btn btn-danger btn-sm float-end">Kembali</a>
    </div>
    <div class="row justify-content-center">
        <div class="col-md-12">
            <?php 
                if(session()->getFlashdata('statustkhblnfp'))
                {
                    ?>
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            <?= session()->getFlashdata('statustkhblnfp'); ?>
            ...
            <div class="export-button-wrapper">
                <form method="post" action="<?= site_url('/failPeribadi/laporanTkhBlnTblPDF') ?>" id="export-form">
                    ...
                    <textarea name="failPeribadiData" hidden><?= json_encode($failPeribadiData) ?></textarea>
                ...
                <form method="post" action="<?= site_url('/failPeribadi/laporanTkhBlnTblExcel') ?>" id="export-form">
                    <input type="hidden" name="reportTitle" value="<?= $reportTitle ?>">
                    <input type="hidden" name="dateDetails" value="<?= $dateDetails ?>">
                    <input type="hidden" name="fileType" value="<?= $fileType ?>">
